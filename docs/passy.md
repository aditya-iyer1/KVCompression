...
- **A. KVCache-Factory** (supports PyramidKV/SnapKV/H2O/StreamingLLM; LongBench-oriented)  [oai_citation:2‡deep-research-report.md](sediment://file_000000006fbc722f85ba7cfc6c2c30fb)  
- **B. SnapKV reference (HF monkeypatch)**  [oai_citation:3‡deep-research-report.md](sediment://file_000000006fbc722f85ba7cfc6c2c30fb)  
- **C. H2O reference (HF; real KV dropping path)**  [oai_citation:4‡deep-research-report.md](sediment://file_000000006fbc722f85ba7cfc6c2c30fb)  
- **D. KVPress (compression_ratio API)**  [oai_citation:5‡deep-research-report.md](sediment://file_000000006fbc722f85ba7cfc6c2c30fb)  

**Constraint:** Do **not** attempt a vLLM fork/kernel patch this week unless you already have one running.

**Check:** You can point to a repo/docs showing (method, budget) is a first-class runtime parameter (token budget / ratio / window).
...
- **Mode 1: OpenAI-compatible server wrapper**  
  Run the backend behind an OpenAI-ish HTTP endpoint so your existing `openai_compat` engine can call it.
